...
public class SundayRecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sunday_recycler);
        setUpRecyclerView();
...
//
//
//        HorizontalCalendar horizontalCalendar = new HorizontalCalendar.Builder(this, R.id.calendarViewSunday)
...
//        });
    ...
    private void setUpRecyclerView(){
        Query query = sundayRef.orderBy("module_order", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_view_sunday);
