...
public class MondayRecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.monday_recycler);
        setUpRecyclerView();
...
//
//
//        HorizontalCalendar horizontalCalendar = new HorizontalCalendar.Builder(this, R.id.calendarViewMonday)
...
//        });
    ...
    private void setUpRecyclerView(){
        Query query = mondayRef.orderBy("module_order", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_view_monday);
