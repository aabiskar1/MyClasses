...
public class ThursdayRecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thursday_recycler);
        setUpRecyclerView();
...
//
//
//        HorizontalCalendar horizontalCalendar = new HorizontalCalendar.Builder(this, R.id.calendarViewThursday)
...
//        });
    ...
    private void setUpRecyclerView(){
        Query query = thursdayRef.orderBy("module_order", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_view_thursday);
