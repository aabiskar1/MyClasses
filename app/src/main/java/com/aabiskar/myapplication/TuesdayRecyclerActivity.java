...
public class TuesdayRecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tuesday_recycler);
        setUpRecyclerView();
...
//
//
//        HorizontalCalendar horizontalCalendar = new HorizontalCalendar.Builder(this, R.id.calendarViewTuesday)
...
//        });
    ...
    private void setUpRecyclerView(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_view_tuesday);
