...
public class WednesdayRecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wednesday_recycler);
        setUpRecyclerView();
//
...
//
//
//        HorizontalCalendar horizontalCalendar = new HorizontalCalendar.Builder(this, R.id.calendarViewWednesday)
...
//        });
    ...
    private void setUpRecyclerView(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_view_wednesday);
